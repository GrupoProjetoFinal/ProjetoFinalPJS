...
namespace Controle_de_Midias
{
    public partial class fm_Pesquisa : Form
    {
        ...
        {
            string qualquerData = "Falso";
            DateTime dataAlbumFIM;
            DateTime dataCompraFIM;
            //if (rtb_Observacao.Text == string.Empty)
            //    rtb_Observacao.Text = "null";
            //if (tb_Interprete.Text == string.Empty)
            //    tb_Interprete.Text = "null";
            //if (tb_Nomemusica.Text == string.Empty)
            //    tb_Nomemusica.Text = "null";
            //if (tb_Autor.Text == string.Empty)
            //    tb_Autor.Text = "null";
            //if (tb_Album.Text == string.Empty)
            //    tb_Album.Text = "null";
            //if (tb_Origemcompra.Text == string.Empty)
            //    tb_Origemcompra.Text = "null";
            if (cb_Tipomidia.Text == "0 - 10")
                midia.tipo = -1;
            else
                midia.tipo = cb_Tipomidia.SelectedIndex - 1;
            if (ckb_QualquerData.Checked)
                qualquerData = "Verdadeiro";
